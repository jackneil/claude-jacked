...
1. If `.claude/skills/ux/SKILL.md` exists (Glob) → read and follow it instead of this file.
2. If `.claude/commands/ux.md` exists (Glob) → read and follow it instead (legacy `/jacked-setup` output).
