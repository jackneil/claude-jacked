 ...
 * Tabbed layout: Agents | Commands | Features | Plugins | Integrations | Claude Code | Appearance | Advanced
 */
    ...
    return `
        <div class="max-w-4xl">
            ...
            <div class="flex gap-1 border-b border-slate-700 mb-6 overflow-x-auto">
                ...
                <button class="settings-tab ${savedTab === 'integrations' ? 'active' : ''}" data-tab="integrations">Integrations</button>
...
async function renderSettingsTab(tabName) {
    ...
    switch (tabName) {
        ...
        case 'plugins':
            ...
            break;
        case 'integrations':
            await renderIntegrationsTab(container);
            break;
        case 'claude-code':
