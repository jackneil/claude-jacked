...
## Strategic Emphasis
Lifecycle lean (Beta): weight the Step 6 decision toward cross-cutting *experience* and operational-reliability levers over one-off features. This tool's recent velocity is dominated by service/menubar/dashboard robustness, upgrade/restart reliability, and multi-account + Codex/Claude parity — so favor moves that lift the whole install → run → observe loop rather than niche additions. Thin signal → smallest high-certainty move over a guess.
...
- **Generated at commit**: 80c35b0660e6d75e996422172c9df585982b491f
