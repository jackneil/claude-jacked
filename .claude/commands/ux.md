...
- **Cross-view state**: settings/gatekeeper toggles, the actions (⋯) menu, and usage refresh all touch shared state — confirm one change doesn't leave another view stale.
