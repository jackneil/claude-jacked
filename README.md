...
Alongside the commands, `jacked install` ships 27 skills: knowledge packs and engines Claude invokes by name or picks up automatically when the task fits. Many power the commands above; the rest stand alone.
